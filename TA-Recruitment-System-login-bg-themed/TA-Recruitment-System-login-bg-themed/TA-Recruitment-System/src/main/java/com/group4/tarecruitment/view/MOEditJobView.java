...
public class MOEditJobView {
    ...
    public Parent createContent() {
        ...
        jobIdLabel.setStyle("-fx-font-weight: bold; -fx-text-fill: #7f8c8d;");
        ...
        form.add(skillLabel, 0, 3);
        form.add(skillArea, 1, 3);
        form.add(contentLabel, 0, 4);
        form.add(contentArea, 1, 4);
        form.add(deadlineLabel, 0, 5);
        form.add(deadlineField, 1, 5);
        ...
        saveBtn.setOnAction(e -> {
            try {
                ...
                if (success) {
                    ...
                    stage.setScene(ThemeManager.createScene(viewJobsView.createContent(), 800, 600));
                } else {
