...
public class AdminController {
    ...
    public void showAdminPanel() {
        ...
        stage.setScene(ThemeManager.createScene(root, 800, 600));
        stage.show();
    }

    private void goBackToRoleSelect() {
        RoleSelectView roleView = new RoleSelectView(stage);
        stage.setScene(ThemeManager.createScene(roleView.createContent(), 800, 600));
    }
    ...
    private Scene createTaWorkloadScene() {
        ...
        return ThemeManager.createScene(view.createContent(), 800, 600);
    }
